...
@WebServlet(name = "diminuiQtdCarrinho", urlPatterns = {"/diminuiQtdCarrinho"})
public class diminuiQtdCarrinho extends HttpServlet {
        ...
        if (request.getParameter("idProduto") != null) {
            ...
            if (p.getId() > 0) {
                ...
                if (produtoExisteNaLista == false) {
                    ...
                    System.out.println(produto.getQtdCarrinho());
                }
                ...
                System.out.println("REMOVER DO CARRINHO: O ID ESPECIFICADO NÃO EXISTE NO BANCO DE DADOS.");
            }
        }
